    ...
    public static class ImportDataService
    {
        ...
        public static void AddImportDataService(this WebApplication app, string sqlConnectionStr)
        {
                ...
                HttpRequest request) =>
            {
                ...
                importDataToQueueService.InsertImportHistory(new ImportDataHistory
                {
                    ImportName= ImportNames.ImportCustomerScore,
                    FileName= formFile.FileName,
                    TotalRows= customerScoreRows.Count,
                    TotalErrorRows= errorList.Count
                });
